...
<div class="main">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nombre" class="form-control" id="nombre" pattern="[a-zA-Z\s]+" placeholder="Carolina Herrera" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="date" name="fecha_nac" class="form-control" id="fecha_nac" min="1990-01-01" max="2005-12-31" required >
    </div>
    <div class="mb-3">
        ...
        <select id="pais" name="pais" class="form-control">
            ...
            <div class="mb-3">
                ...
                <select id="deporte" name="deporte" class="form-control">
                    ...
                    <option value="Gimnasia En Trampolín">Gimnasia En Trampolín</option>
                    <option value="Triatlón">Triatlón</option>
                </select>
            </div>
            <button type="submit" style="background-color: #A6BCDB; color: white; border-color: white">Enviar</button>
        </form>
    </main>
    <aside class="right">
    </aside>
